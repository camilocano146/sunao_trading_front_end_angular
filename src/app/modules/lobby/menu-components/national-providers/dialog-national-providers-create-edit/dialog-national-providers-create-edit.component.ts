...
@Component({
  selector: 'app-dialog-national-providers-create-edit',
  templateUrl: './dialog-national-providers-create-edit.component.html',
  styleUrls: ['./dialog-national-providers-create-edit.component.scss']
})
export class DialogNationalProvidersCreateEditComponent implements OnInit {
  /**
   * Preload create/edit
   */
   ...
   constructor(
     ...
     public dialogRef: MatDialogRef<DialogNationalProvidersCreateEditComponent>,
   ...
   saveOrEdit(): void {
     ...
     if (this.formControlName.valid && this.formControlEmail.valid && this.formControlAddress.valid && this.formControlPhone.valid) {
       ...
       let observable;
       if (this.dataEdit) {
         observable = this.providerService.editNational(this.dataEdit.id, body);
       } else {
         observable = this.providerService.registerNational(body);
       }
